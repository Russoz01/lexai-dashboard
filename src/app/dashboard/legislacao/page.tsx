        ...
        <div style={{ marginBottom: 28 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 14 }} className="study-grid">
            {[
              ...
              { nome: 'Constituição Federal 1988', desc: 'Texto integral atualizado no Planalto', url: 'https://www.planalto.gov.br/ccivil_03/constituicao/constituicao.htm', Icon: Landmark, color: 'var(--accent)' },
              ...
              { nome: 'Código de Processo Civil (Lei 13.105/15)', desc: 'CPC/2015 atualizado', url: 'https://www.planalto.gov.br/ccivil_03/_ato2015-2018/2015/lei/l13105.htm', Icon: NotebookText, color: 'var(--warning)' },
              { nome: 'Código de Processo Penal (DL 3.689/41)', desc: 'CPP brasileiro consolidado', url: 'https://www.planalto.gov.br/ccivil_03/decreto-lei/del3689compilado.htm', Icon: Gavel, color: 'var(--accent)' },
              ...
              { nome: 'CTN (Lei 5.172/66)', desc: 'Código Tributário Nacional', url: 'https://www.planalto.gov.br/ccivil_03/leis/l5172compilado.htm', Icon: Coins, color: 'var(--warning)' },
              { nome: 'Código Eleitoral (Lei 4.737/65)', desc: 'Texto consolidado eleitoral', url: 'https://www.planalto.gov.br/ccivil_03/leis/l4737compilado.htm', Icon: CheckSquare, color: 'var(--accent)' },
              ...
              { nome: 'Súmulas STF/STJ', desc: 'Índice de súmulas dos tribunais superiores', url: 'https://portal.stf.jus.br/jurisprudencia/sumarioSumulas.asp', Icon: Bookmark, color: 'var(--warning)' },
            ].map((rec, i) => {
