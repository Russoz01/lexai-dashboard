...
export const metadata: Metadata = {
  ...
  title: 'LexAI — Inteligencia Juridica · uma marca Pralvex',
  description: 'LexAI, uma marca Pralvex. Plataforma de inteligencia artificial para escritorios de advocacia. 22 agentes IA especializados: analise de documentos, pesquisa jurisprudencial, redacao de pecas, negociacao, calculos juridicos e mais.',
  keywords: 'lexai, pralvex, assistente juridico, inteligencia artificial, direito, advogado, escritorio advocacia, jurisprudencia, pecas processuais, ia juridica',
...
const organizationJsonLd = {
  ...
  description: 'Pralvex e o estudio por tras da LexAI, plataforma de inteligencia artificial para escritorios de advocacia brasileiros.',
  foundingDate: '2025',
  sameAs: [
    'https://lexai.com.br',
  ],
