    ...
    <div style={{ minHeight: '100vh', background: '#0A0A0A', color: '#F1F1F1', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '20px 48px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <a href={CALENDLY_URL} target="_blank" rel="noopener noreferrer" style={{ fontSize: 14, color: '#fff', background: '#2563EB', padding: '8px 20px', borderRadius: 8, textDecoration: 'none', fontWeight: 600 }}>
            Agendar demo
          </a>
        </div>
      </nav>
      ...
      <section style={{ textAlign: 'center', padding: '100px 24px 60px', maxWidth: 900, margin: '0 auto' }}>
        ...
        <h1 style={{ fontSize: 56, fontWeight: 800, letterSpacing: '-2px', lineHeight: 1.1, marginBottom: 20 }}>
          ...
          <span style={{ color: '#3B82F6' }}>maquina de eficiencia juridica</span>
        </h1>
        ...
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
          <a href={CALENDLY_URL} target="_blank" rel="noopener noreferrer" style={{ fontSize: 16, color: '#fff', background: '#2563EB', padding: '14px 32px', borderRadius: 10, textDecoration: 'none', fontWeight: 600, boxShadow: '0 4px 16px rgba(37,99,235,0.30)' }}>
      ...
      <section style={{ padding: '60px 48px', maxWidth: 1100, margin: '0 auto' }}>
        <div className="stats-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 20 }}>
          {[
            { value: '10x', label: 'mais rapido', icon: 'bi-lightning-charge-fill', color: '#3B82F6' },
      ...
      <section style={{ padding: '80px 48px', maxWidth: 900, margin: '0 auto' }}>
        <div style={{
          ...
          <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', color: '#3B82F6', marginBottom: 12 }}>
            Plano Enterprise
          </div>
          <h2 style={{ fontSize: 36, fontWeight: 800, color: '#fff', letterSpacing: '-1.5px', marginBottom: 12 }}>
            A partir de <span style={{ color: '#3B82F6' }}>R$ 239/mes</span>
          </h2>
          ...
          <a href={CALENDLY_URL} target="_blank" rel="noopener noreferrer" style={{
            ...
            fontSize: 16, color: '#fff', background: '#2563EB', padding: '14px 32px', borderRadius: 10, textDecoration: 'none', fontWeight: 600,
      ...
      <section style={{ textAlign: 'center', padding: '60px 24px 80px', maxWidth: 800, margin: '0 auto' }}>
        ...
        <a href={CALENDLY_URL} target="_blank" rel="noopener noreferrer" style={{
          display: 'inline-flex', alignItems: 'center', gap: 8,
          fontSize: 17, color: '#fff', background: '#2563EB', padding: '16px 40px', borderRadius: 12, textDecoration: 'none', fontWeight: 600,
